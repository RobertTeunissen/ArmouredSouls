...
- [x] 1. Drop dead scheduling tables

  - [x] 1.1 Remove `ScheduledLeagueMatch` model and relations from schema
  ...
  - [x] 1.2 Remove `ScheduledKothMatch` and `ScheduledKothMatchParticipant` models and relations from schema
  ...
  - [x] 1.3 Remove `ScheduledTeamBattleMatch` model and relations from schema
  ...
  - [x] 1.4 Run migration and verify build
...
- [x] 2. Read path migrations — KotH and Hall of Records

  - [x] 2.1 Migrate `kothAnalyticsService.ts` to read from standings
  ...
  - [x] 2.2 Migrate `records-queries.ts` `fetchKothRecords()` to read from standings
  ...
  - [x] 2.3 Update KotH-related tests
...
- [x] 3. Read path migrations — Leaderboard, Stable View, Profile, Finances

  - [x] 3.1 Migrate `leaderboardService.ts` league filter to use standings
  ...
  - [x] 3.2 Migrate `stableViewService.ts` team stats to use standings
  ...
  - [x] 3.3 Migrate `userProfileService.ts` tag team stats to use standings
  ...
  - [x] 3.4 Migrate `finances.ts` and `economyCalculations.ts` league reads
  ...
  - [x] 3.5 Migrate remaining `currentLeague` / `teamLeague` reads (matchHistory, tournamentParticipantResolver, teamBattles route)
  ...
  - [x] 3.6 Verify and migrate `triggerEvaluator.ts` achievement reads
  ...
  - [x] 3.7 Update tests for migrated read paths
...
- [x] 4. Battle ELO dual-write removal

  - [x] 4.1 Remove ELO column writes from all battle orchestrators
  ...
  - [x] 4.2 Migrate ELO reads from Battle columns to battle_participants
  ...
  - [x] 4.3 Update tests for ELO column removal
...
- [x] 5. Battle tag-team dual-write removal

  - [x] 5.1 Remove tag-team column writes from battle creation
  ...
  - [x] 5.2 Migrate tag-team reads to battle_participants
  ...
  - [x] 5.3 Update tests for tag-team column removal
...
- [x] 6. Schema migrations — Column drops

  - [x] 6.1 Drop 26 Robot legacy columns
  ...
  - [x] 6.2 Drop 14 TeamBattle legacy columns
  ...
  - [x] 6.3 Make 19 Battle ELO and tag-team columns nullable
...
- [x] 7. Interface cleanup and bye-robot type fixes

  - [x] 7.1 Update bye-robot and bye-team constructors
  ...
  - [x] 7.2 Update `TagTeamWithRobots` interface and team creation
  ...
  - [x] 7.3 Verify BattleSummary model is unaffected
  ...
  - [x] 7.4 Update remaining raw SQL queries
  ...
  - [x] 7.5 Full build and test verification after column drops
    - Run `pnpm run build` in `app/backend/` — must exit 0
...
- [x] 8. Documentation updates
  ...
  - [x] 8.2 Update architecture and guide documentation
  ...
  - [x] 8.3 Update backlog and remove superseded plan
...
- [x] 9. Final verification
  ...
  - [x] 9.1 Run all verification criteria from requirements
