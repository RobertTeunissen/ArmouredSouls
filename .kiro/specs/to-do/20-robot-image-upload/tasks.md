...
- [ ] 1. Install dependencies and create moderation service directory
...
- [ ] 2. Implement File Validation Service
  - [ ] 2.1 Create `app/backend/src/services/moderation/fileValidationService.ts`
  ...
  - [ ] 2.2 Write unit tests for File Validation Service
  ...
  - [ ] 2.3 Write property test for magic byte authority (Property 3)
  ...
  - [ ] 2.4 Write property test for invalid file rejection (Property 4)
...
- [ ] 3. Implement Content Moderation Service
  - [ ] 3.1 Create `app/backend/src/services/moderation/contentModerationService.ts`
  ...
  - [ ] 3.2 Write unit tests for Content Moderation Service
  ...
  - [ ] 3.3 Write property test for NSFW threshold consistency (Property 5)
  ...
  - [ ] 3.4 Write property test for robot-likeness soft warning with override (Property 7)
...
- [ ] 4. Implement Image Processing Service
  - [ ] 4.1 Create `app/backend/src/services/moderation/imageProcessingService.ts`
  ...
  - [ ] 4.2 Write unit tests for Image Processing Service
  ...
  - [ ] 4.3 Write property test for image processing output invariant (Property 8)
...
- [ ] 5. Checkpoint — Ensure all service unit and property tests pass
  - Run `cd app/backend && npx jest --testPathPattern="services/moderation" --no-coverage` and ensure all tests pass
  - Ask the user if questions arise

- [ ] 6. Implement File Storage Service and Pending Upload Cache
  - [ ] 6.1 Create `app/backend/src/services/moderation/fileStorageService.ts`
  ...
  - [ ] 6.2 Create `app/backend/src/services/moderation/pendingUploadCache.ts`
  ...
  - [ ] 6.3 Write unit tests for File Storage Service
  ...
  - [ ] 6.4 Write unit tests for Pending Upload Cache
  ...
  - [ ] 6.5 Write property test for valid URL path format (Property 9)
  ...
  - [ ] 6.6 Write property test for pending upload cache TTL eviction (Property 12)
  ...
  - [ ] 6.7 Write property test for orphan cleanup correctness (Property 15)
...
- [ ] 7. Implement Upload Preview and Confirm Route Handlers
  - [ ] 7.1 Create upload rate limiter in `app/backend/src/services/moderation/uploadRateLimiter.ts`
  ...
  - [ ] 7.2 Create `app/backend/src/services/moderation/imageUploadHandlers.ts`
  ...
  - [ ] 7.3 Implement `handleImageConfirm(req, res)` in the same file
  ...
  - [ ] 7.4 Register routes in `app/backend/src/routes/robots.ts`
  ...
  - [ ] 7.5 Write unit tests for preview and confirm handlers
  ...
  - [ ] 7.6 Write property test for ownership isolation (Property 1)
  ...
  - [ ] 7.7 Write property test for preview produces no disk writes (Property 2)
  ...
  - [ ] 7.8 Write property test for no score leakage (Property 6)
  ...
  - [ ] 7.9 Write property test for dual audit logging (Property 10)
  ...
  - [ ] 7.10 Write property test for robot-likeness override still enforces NSFW (Property 16)
...
- [ ] 8. Checkpoint — Ensure all backend handler tests pass
  - Run `cd app/backend && npx jest --testPathPattern="services/moderation" --no-coverage` and ensure all tests pass
  - Ask the user if questions arise

- [ ] 9. Implement Orphan Cleanup Job and Eager Cleanup Hooks
  - [ ] 9.1 Create `app/backend/src/services/moderation/orphanCleanupJob.ts`
  ...
  - [ ] 9.2 Integrate orphan cleanup as Step 15 in `app/backend/src/services/admin/adminCycleService.ts`
  ...
  - [ ] 9.3 Add eager cleanup hooks for robot image changes
  ...
  - [ ] 9.4 Write unit tests for orphan cleanup and eager cleanup
  ...
  - [ ] 9.5 Write property test for orphaned image cleanup on preset switch (Property 13)
  ...
  - [ ] 9.6 Write property test for orphaned image cleanup on robot deletion (Property 14)
...
- [ ] 10. Implement Admin Endpoints
  - [ ] 10.1 Create admin uploads handler in `app/backend/src/services/moderation/adminUploadsHandler.ts`
  ...
  - [ ] 10.4 Write unit tests for admin endpoints
  ...
  - [ ] 10.5 Write property test for admin uploads pagination consistency (Property 17)
...
- [ ] 12. Initialize Content Moderation Service at Application Startup
...
- [ ] 13. Implement Frontend Upload Tab in RobotImageSelector
  - [ ] 13.1 Extend `app/frontend/src/components/RobotImageSelector.tsx` with tab navigation
  ...
  - [ ] 13.2 Implement upload tab component within RobotImageSelector
  ...
  - [ ] 13.3 Implement server preview and confirmation flow
  ...
  - [ ] 13.4 Implement error handling in upload flow
  ...
  - [ ] 13.6 Write property test for frontend file validation mirrors backend (Property 11)
...
- [ ] 14. Configure Caddy Static File Serving
...
- [ ] 15. Checkpoint — Ensure frontend builds and all tests pass
  - Run `cd app/frontend && npm run build` and ensure it succeeds
  - Run `cd app/backend && npx jest --testPathPattern="services/moderation" --no-coverage` and ensure all tests pass
  - Ask the user if questions arise

- [ ] 16. Update Documentation
  - [ ] 16.1 Update `docs/guides/SECURITY.md`
  ...
  - [ ] 16.2 Update `docs/guides/DEPLOYMENT.md`
  ...
  - [ ] 16.3 Update `docs/prd_core/ARCHITECTURE.md`
  ...
  - [ ] 16.4 Update `docs/prd_core/DATABASE_SCHEMA.md`
  ...
  - [ ] 16.5 Update `docs/prd_pages/PRD_ROBOT_DETAIL_PAGE.md`
  ...
  - [ ] 16.6 Update `docs/guides/ERROR_CODES.md`
  ...
  - [ ] 16.7 Update `.kiro/steering/coding-standards.md`
...
- [ ] 17. Final verification — Run verification criteria and confirm spec delivery
