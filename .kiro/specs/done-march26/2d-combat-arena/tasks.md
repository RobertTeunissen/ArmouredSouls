...
- [x] 1. Create core spatial math and type foundations
  - [x] 1.1 Create `app/backend/src/services/arena/vector2d.ts` with 2D math utilities
  ...
  - [x] 1.3 Create `app/backend/src/services/arena/types.ts` with all spatial interfaces
...
- [x] 2. Implement arena layout and range band systems
  - [x] 2.1 Create `app/backend/src/services/arena/arenaLayout.ts`
  ...
  - [x] 2.3 Create `app/backend/src/services/arena/rangeBands.ts`
...
- [x] 4. Implement movement and servo strain systems
  - [x] 4.1 Create `app/backend/src/services/arena/servoStrain.ts`
  ...
  - [x] 4.3 Create `app/backend/src/services/arena/positionTracker.ts`
...
- [x] 5. Implement AI decision and attribute systems
  - [x] 5.1 Create `app/backend/src/services/arena/movementAI.ts`
  ...
  - [x] 5.3 Create `app/backend/src/services/arena/adaptationTracker.ts`
  ...
  - [x] 5.5 Create `app/backend/src/services/arena/pressureSystem.ts`
  ...
  - [x] 5.7 Create `app/backend/src/services/arena/threatScoring.ts`
...
- [x] 7. Refactor the main combat simulator with spatial mechanics
  - [x] 7.1 Create `app/backend/src/services/arena/hydraulicBonus.ts`
    - Implement `calculateHydraulicBonus(hydraulicSystems, rangeBand)` — melee: 1 + hydro × 0.03, short: 1 + hydro × 0.015, mid/long: 1.0
    - _Requirements: 4.1, 4.2, 4.3_

  - [x] 7.2 Create `app/backend/src/services/arena/teamCoordination.ts`
  ...
  - [x] 7.3 Create `app/backend/src/services/arena/counterAttack.ts`
  ...
  - [x] 7.5 Refactor `app/backend/src/services/combatSimulator.ts` — integrate spatial simulation loop
...
- [x] 9. Update CombatMessageGenerator for spatial events
  - [x] 9.1 Modify `app/backend/src/services/combatMessageGenerator.ts`
...
- [x] 10. Implement frontend Battle Playback Viewer
  - [x] 10.1 Create `app/frontend/src/components/BattlePlaybackViewer/types.ts`
    - Define playback-specific types: PlaybackState, PlaybackSpeed, InterpolatedFrame
    - _Requirements: 17.7_

  - [x] 10.2 Create `app/frontend/src/components/BattlePlaybackViewer/usePlaybackEngine.ts`
  ...
  - [x] 10.3 Create `app/frontend/src/components/BattlePlaybackViewer/canvasRenderer.ts`
  ...
  - [x] 10.4 Create `app/frontend/src/components/BattlePlaybackViewer/ArenaCanvas.tsx`
  ...
  - [x] 10.5 Create `app/frontend/src/components/BattlePlaybackViewer/PlaybackControls.tsx`
  ...
  - [x] 10.6 Create `app/frontend/src/components/BattlePlaybackViewer/CombatLogPanel.tsx`
  ...
  - [x] 10.7 Create `app/frontend/src/components/BattlePlaybackViewer/BattlePlaybackViewer.tsx`
...
- [x] 11. Implement Weapon Shop range filter and Battle Results spatial summary
  - [x] 11.1 Create shared `getWeaponOptimalRange()` utility for frontend
    - Create `app/frontend/src/utils/weaponRange.ts` with the same weapon-to-range-band mapping as the backend
    - _Requirements: 18.1_
...
- All new modules under `app/backend/src/services/arena/` are pure functions
