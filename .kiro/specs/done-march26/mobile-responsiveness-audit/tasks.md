...
- [x] 1. Write bug condition exploration test
  ...
  - Test file: `app/frontend/src/__tests__/mobile-responsiveness-bug-condition.test.ts`
...
- [x] 2. Write preservation property tests (BEFORE implementing fix)
  ...
  - Test file: `app/frontend/src/__tests__/mobile-responsiveness-preservation.test.ts`
...
- [x] 3. Fix for mobile responsiveness defects across all affected pages
  ...
  - [x] 3.1 Align breakpoint in useIsMobile hooks to 1024px
    - In `app/frontend/src/hooks/useIsMobile.ts`: change `MOBILE_BREAKPOINT` from `768` to `1024`
    - In `app/frontend/src/hooks/useMediaQuery.ts`: change convenience `useIsMobile()` from `max-width: 768px` to `max-width: 1023px`
  ...
  - [x] 3.2 Fix LeagueStandingsPage mobile layout
    - In `app/frontend/src/pages/LeagueStandingsPage.tsx`:
  ...
  - [x] 3.3 Fix AdminPage tab navigation and stats grid
    - In `app/frontend/src/pages/AdminPage.tsx`:
  ...
  - [x] 3.5 Fix BattleHistoryPage filter controls
    - In `app/frontend/src/pages/BattleHistoryPage.tsx`:
  ...
  - [x] 3.6 Fix FinancialReportPage header and layout
    - In `app/frontend/src/pages/FinancialReportPage.tsx`:
  ...
  - [x] 3.7 Fix HallOfRecordsPage grid
    - In `app/frontend/src/pages/HallOfRecordsPage.tsx`:
  ...
  - [x] 3.9 Fix TournamentDetailPage bracket
    - In `app/frontend/src/pages/TournamentDetailPage.tsx`:
  ...
  - [x] 3.10 Fix touch target sizing across pages with tables and forms
    ...
    - Add `min-h-[44px]` to form inputs and buttons on ProfilePage (`app/frontend/src/pages/ProfilePage.tsx`), CreateRobotPage (`app/frontend/src/pages/CreateRobotPage.tsx`), OnboardingPage (`app/frontend/src/pages/OnboardingPage.tsx`)
  ...
  - [x] 3.12 Fix WeaponShopPage cards
    - In `app/frontend/src/pages/WeaponShopPage.tsx`:
  ...
  - [x] 3.13 Verify bug condition exploration test now passes
    ...
    - Run bug condition exploration test from step 1: `app/frontend/src/__tests__/mobile-responsiveness-bug-condition.test.ts`
  ...
  - [x] 3.14 Verify preservation tests still pass
    ...
    - Run preservation property tests from step 2: `app/frontend/src/__tests__/mobile-responsiveness-preservation.test.ts`
