...
Do not rewrite old amounts, fabricate pairs, or relabel legacy rows. Rows without a financial identity remain readable history; diagnostics assess only identified paired evidence.
