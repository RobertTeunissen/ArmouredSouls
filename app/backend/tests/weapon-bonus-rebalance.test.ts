...
/** Weapons modified by the DPS rebalance (Spec #31) — baseDamage and/or cooldown changed */
...
const NON_BONUS_SNAPSHOT: Record<string, Record<string, unknown>> = {
  ...
  'Machine Pistol': {
    name: 'Machine Pistol', baseDamage: 4.5, cooldown: 2, weaponType: 'ballistic',
    handsRequired: 'one', damageType: 'ballistic', loadoutType: 'single',
  ...
  'Combat Knife': {
    name: 'Combat Knife', baseDamage: 4.5, cooldown: 2, weaponType: 'melee',
    handsRequired: 'one', damageType: 'melee', loadoutType: 'single',
  ...
  'Machine Gun': {
    name: 'Machine Gun', baseDamage: 4.5, cooldown: 2, weaponType: 'ballistic',
    handsRequired: 'one', damageType: 'ballistic', loadoutType: 'single',
    cost: 107000, specialProperty: null, description: 'Sustained fire support weapon',
  },
  'Burst Rifle': {
    name: 'Burst Rifle', baseDamage: 7, cooldown: 3, weaponType: 'ballistic',
    handsRequired: 'one', damageType: 'ballistic', loadoutType: 'single',
  ...
  'Pulse Accelerator': {
    name: 'Pulse Accelerator', baseDamage: 10.5, cooldown: 4, weaponType: 'energy',
    handsRequired: 'two', damageType: 'energy', loadoutType: 'two_handed',
  ...
  'Arc Projector': {
    name: 'Arc Projector', baseDamage: 13, cooldown: 4, weaponType: 'energy',
    handsRequired: 'two', damageType: 'energy', loadoutType: 'two_handed',
  ...
  'Gauss Pistol': {
    name: 'Gauss Pistol', baseDamage: 10, cooldown: 3, weaponType: 'ballistic',
    handsRequired: 'one', damageType: 'ballistic', loadoutType: 'single',
  ...
  'Particle Lance': {
    name: 'Particle Lance', baseDamage: 16, cooldown: 4, weaponType: 'energy',
    handsRequired: 'one', damageType: 'energy', loadoutType: 'single',
    cost: 425000, specialProperty: null, description: 'Focused particle beam weapon capable of precision strikes at extreme range',
  },
  'Siege Cannon': {
    name: 'Siege Cannon', baseDamage: 9, cooldown: 4, weaponType: 'ballistic',
    handsRequired: 'two', damageType: 'ballistic', loadoutType: 'two_handed',
