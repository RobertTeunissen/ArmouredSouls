...
function arbBattleResult(team1: TagTeamWithRobots, team2: TagTeamWithRobots) {
  return fc
    .record({
      ...
      team1ActiveDamageDealt: fc.integer({ min: 0, max: 5000 }),
      team1ReserveDamageDealt: fc.integer({ min: 0, max: 5000 }),
      team2ActiveDamageDealt: fc.integer({ min: 0, max: 5000 }),
      team2ReserveDamageDealt: fc.integer({ min: 0, max: 5000 }),
    ...
    .map((fields) => ({
      ...
      team1ActiveDamageDealt: fields.team1ActiveDamageDealt,
      team1ReserveDamageDealt: fields.team1ReserveDamageDealt,
      team2ActiveDamageDealt: fields.team2ActiveDamageDealt,
      team2ReserveDamageDealt: fields.team2ReserveDamageDealt,
