...
export const EconomyErrorCode = {
  ...
  // Weapon refinement (Spec #34)
  WEAPON_REFINEMENT_TIER_LOCKED: 'WEAPON_REFINEMENT_TIER_LOCKED',
  WEAPON_REFINEMENT_SLOT_CAP_EXCEEDED: 'WEAPON_REFINEMENT_SLOT_CAP_EXCEEDED',
  WEAPON_REFINEMENT_TIER_CAP_EXCEEDED: 'WEAPON_REFINEMENT_TIER_CAP_EXCEEDED',
  WEAPON_REFINEMENT_ATTRIBUTE_STACK_CAP_EXCEEDED: 'WEAPON_REFINEMENT_ATTRIBUTE_STACK_CAP_EXCEEDED',
  WEAPON_REFINEMENT_MAGNITUDE_OUT_OF_RANGE: 'WEAPON_REFINEMENT_MAGNITUDE_OUT_OF_RANGE',
  WEAPON_REFINEMENT_ATTRIBUTE_NOT_ON_WEAPON: 'WEAPON_REFINEMENT_ATTRIBUTE_NOT_ON_WEAPON',
  WEAPON_REFINEMENT_ATTRIBUTE_ALREADY_ON_WEAPON: 'WEAPON_REFINEMENT_ATTRIBUTE_ALREADY_ON_WEAPON',
  WEAPON_REFINEMENT_SHIELD_CANNOT_TAKE_DPS_TIER: 'WEAPON_REFINEMENT_SHIELD_CANNOT_TAKE_DPS_TIER',
} as const;
