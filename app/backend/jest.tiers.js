...
const HEAVY_TESTS = [
  ...
  'tests/financeCenterPerformance.integration.test.ts',
...
const DB_DEPENDENT = [
  ...
  'tests/financeCenter.integration.test.ts',
  'tests/finances.test.ts',
  'tests/financialLedgerCoverage.integration.test.ts',
  'tests/financialWriteTransaction.integration.test.ts',
