...
import TagTeamSubscriptionWarning from '../subscriptions/TagTeamSubscriptionWarning';
...
/**
 * Tag Team management content — extracted from TagTeamManagementPage for reuse
 * inside the unified TeamBattlesPage tabs.
 */
function TagTeamManagementContent() {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-white">Tag Team Management</h2>
          <p className="text-secondary mt-1">Manage your 2v2 tag battle teams</p>
        </div>
        <button
      ...
      {!loading && !error && teams.length === 0 && (
        <div className="bg-surface-elevated p-8 rounded-lg border border-white/10 text-center">
          <div className="max-w-2xl mx-auto">
            <h3 className="text-xl font-bold mb-4">No Tag Teams Yet</h3>
            <p className="text-secondary mb-6">
              Create your first tag team to compete in 2v2 battles! Select two robots from your stable to form a powerful duo.
            </p>
            <button
              onClick={() => setShowCreateModal(true)}
              className="bg-primary hover:bg-primary-dark text-white font-bold py-3 px-8 rounded-lg text-lg transition-colors min-h-[44px]"
            >
...
/* ------------------------------------------------------------------ */
/*  Tag Team Card (reused from TagTeamManagementPage)                   */
/* ------------------------------------------------------------------ */
  ...
  return (
    <div className="bg-surface-elevated border border-white/10 rounded-lg p-6 hover:border-primary/50 transition-all">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          onClick={onDisband}
          className="text-error hover:text-error/80 text-sm font-semibold transition-colors min-h-[44px] min-w-[44px]"
        >
          Disband
        </button>
      </div>
  ...
  return (
    <div className="mt-4 pt-4 border-t border-white/10" data-testid="tag-team-league-history">
      <button
        ...
        className="flex items-center gap-2 text-sm text-secondary hover:text-white transition-colors w-full text-left min-h-[44px]"
...
export default TagTeamManagementContent;
