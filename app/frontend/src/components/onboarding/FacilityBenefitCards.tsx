...
const FACILITY_BENEFITS: FacilityBenefit[] = [
  {
    ...
    discountRange: '10% (Level 1) to 100% (Level 10)',
    examples: [
      {
        scenario: 'Buying a Laser Rifle (₡275K) at Level 1',
        withoutFacility: '₡275,000',
        withFacility: '₡247,500 (10% discount)',
        savings: '₡27,500 saved',
      },
      {
        scenario: 'Buying a Laser Rifle (₡275K) at Level 5',
        withoutFacility: '₡275,000',
        withFacility: '₡137,500 (50% discount)',
        savings: '₡137,500 saved',
      },
      {
        scenario: 'Buying 3 weapons (₡600K total) at Level 10',
        withoutFacility: '₡600,000',
        withFacility: '₡0 (100% discount)',
        savings: '₡600,000 saved',
      },
    ],
    keyPoints: [
      'Purchase BEFORE buying weapons to maximize savings',
      'Savings apply to every weapon purchase',
      'Level 1 provides 10% discount (good starting point)',
      'Level 5 provides 50% discount (half price weapons)',
      'Level 10 provides 100% discount (free weapons)',
    ],
  ...
  },
  {
    ...
    discountRange: '10% (Level 1) to 90% (Level 9)',
    examples: [
      {
      ...
      },
      {
        ...
        withFacility: '₡207,000 (90% discount at Level 9)',
    ...
    keyPoints: [
      ...
      'Level 1 provides 10% discount',
      'Level 5 provides 50% discount (half price upgrades)',
      'Level 9 provides 90% discount (maximum savings)',
    ],
  ...
  },
  {
    type: 'repair_bay',
    name: 'Repair Bay',
    description: 'Reduces the cost of repairing damaged robots after battles. Discount scales with both facility level and number of active robots.',
    discountRange: 'Level × (5 + robot count), capped at 90%',
    examples: [
      {
        scenario: 'Level 5 with 1 robot (30% discount)',
        withoutFacility: '₡100,000 repair',
        withFacility: '₡70,000',
        savings: '₡30,000 saved per repair',
      },
      {
        scenario: 'Level 5 with 3 robots (40% discount)',
        withoutFacility: '₡100,000 repair',
        withFacility: '₡60,000',
        savings: '₡40,000 saved per repair',
      },
      {
        scenario: 'Level 10 with 3 robots (80% discount)',
        withoutFacility: '₡100,000 repair',
        withFacility: '₡20,000',
        savings: '₡80,000 saved per repair',
      },
    ],
    keyPoints: [
      'Discount formula: Level × (5 + robot count)',
      'More robots = higher discount percentage',
      'Maximum discount capped at 90%',
      'More valuable for multi-robot strategies',
