  ...
  baseRecommendations.push(
    {
      ...
      level: 1,
      operatingCost: 100,
      benefit: '10% discount on weapon purchases (Level 1)',
      savingsExample: 'Save ₡27.5K on a ₡275K weapon',
      reason: 'Purchase BEFORE buying weapons to maximize savings. Saves 10% per level. Can upgrade to higher levels later.',
    },
    {
      ...
      savingsExample: 'Save ₡40K when upgrading all 23 attributes from Level 1→5',
      reason: 'Purchase BEFORE upgrading attributes. Savings compound over time. Saves 10% per level (up to 90% at Level 9).',
    },
    {
      type: 'repair_bay',
      name: 'Repair Bay',
