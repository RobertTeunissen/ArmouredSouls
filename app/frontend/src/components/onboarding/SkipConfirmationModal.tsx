  ...
  >
    <div ref={modalRef} className="bg-surface rounded-lg border border-white/10 max-w-md w-full p-6">
      ...
      <div id="skip-confirm-desc">
        ...
        <ul className="list-disc list-inside text-secondary mb-6 space-y-2" role="list">
      ...
      <div className="flex gap-4">
        <button
          onClick={onCancel}
          className="flex-1 px-4 py-2 bg-surface-elevated hover:bg-gray-600 text-white rounded transition-colors min-h-[44px]"
