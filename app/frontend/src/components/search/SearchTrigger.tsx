...
import { useSearchShortcutLabel } from '../../utils/searchShortcut';
  ...
  return (
    ...
    >
      ...
      {!isMobile ? (
        <>
          <span>Search</span>
          <kbd className="rounded border border-white/20 px-1.5 py-0.5 text-xs text-secondary">{shortcutLabel}</kbd>
        </>
      ) : null}
    </button>
  );
