    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div className="bg-surface rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex gap-3 mt-1">
                <span className="text-sm text-secondary capitalize">{weapon.weaponType}</span>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-surface-elevated rounded p-3">
                <div className="text-sm text-secondary">Base Damage</div>
                <div className="text-2xl font-bold">{weapon.baseDamage}</div>
              </div>
              <div className="bg-surface-elevated rounded p-3">
                <div className="text-sm text-secondary">Cooldown</div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {attributeBonuses.map((bonus, idx) => (
                  <div key={idx} className="flex justify-between items-center bg-surface-elevated rounded px-3 py-2">
                    <span className="text-sm text-secondary">{bonus.label}</span>
                    <span className={`font-semibold ${bonus.value > 0 ? 'text-success' : 'text-error'}`}>
          ...
          <div className="bg-surface-elevated rounded-lg p-4">
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                ...
                <div className={`text-2xl font-bold ${canAfford ? 'text-success' : 'text-error'}`}>
        ...
        <div className="border-t border-white/10 p-6 flex justify-between items-center">
          <div className="text-sm text-secondary">
            Your Credits: <span className={canAfford ? 'text-success' : 'text-error'}>
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="px-6 py-2 bg-surface-elevated hover:bg-gray-600 rounded-lg transition-colors"
            >
              Close
            </button>
            <button
