...
2. Place final PNGs in the corresponding folders (e.g. app/frontend/src/assets/robots/).
3. Run the conversion script to produce WEBP versions and retina variants:
   - Install deps: `npm install sharp`
   - `node app/frontend/src/assets/scripts/convert_svgs_to_webp.js --in ./app/frontend/src/assets/robots --out ./app/frontend/src/assets/robots --sizes 64,128,256,512 --quality 85`
