...
const AdminCycleExplorerPage = React.lazy(() => import('./pages/admin/CycleExplorerPage'));
...
const AdminPlayerEngagementPage = React.lazy(() => import('./pages/admin/PlayerEngagementPage'));
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      {/* ----------------------------------------------------------------- */}
      {/* Admin routes — nested under /admin/*, guarded by AdminRoute       */}
      {/* Only registered when the authenticated user has the admin role     */}
      {/* ----------------------------------------------------------------- */}
      {isAdmin && (
        <Route path="/admin" element={<AdminRoute><AdminLayout /></AdminRoute>}>
          ...
          <Route path="cycles/history" element={<AdminCycleExplorerPage />} />
          ...
          <Route path="engagement" element={<AdminPlayerEngagementPage />} />
