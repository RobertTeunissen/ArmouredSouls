...
1. `app/backend/src/services/battle/combatSimulator.ts` — Added `simulateBattleMulti()` time limit handling (section 5), result building (section 6), and backward-compatible `simulateBattle()` wrapper
