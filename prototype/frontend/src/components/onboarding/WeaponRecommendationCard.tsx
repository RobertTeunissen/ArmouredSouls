...
const LoadoutCompatibilityBadge = ({ 
  ...
  return (
    <div className="space-y-1">
      <div className="text-xs text-secondary">Compatible Loadouts:</div>
...
const BudgetIndicator = ({ 
  ...
  return (
    <div className={`text-xs ${canAfford ? 'text-success' : 'text-error'}`}>
      {canAfford ? (
        <>
    ...
    return (
      <div
        className={`
          ...
          ${recommended ? 'border-blue-500 ring-2 ring-blue-500 ring-opacity-30' : 'border-white/10'}
      ...
      >
        {recommended && (
          <div className="absolute top-2 right-2 bg-primary-dark text-white px-2 py-0.5 rounded-full text-xs font-bold">
            RECOMMENDED
          </div>
        )}
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-secondary mb-2">{weapon.description}</p>
  ...
  return (
    <div
      className={`
        ...
        ${recommended ? 'border-blue-500 ring-4 ring-blue-500 ring-opacity-30 shadow-xl' : 'border-white/10'}
    ...
    >
      ...
      {/* Description */}
      <p className="text-sm text-secondary mb-4">{weapon.description}</p>
      ...
      <div className="mb-4">
        ...
        <div className="p-3 bg-surface bg-opacity-50 rounded-lg">
      ...
      {onSelect && canAfford && isCompatible && (
        <div className="mt-4 pt-4 border-t border-white/10 text-center">
          <p className="text-xs text-secondary">Click to select this weapon</p>
        </div>
      )}
