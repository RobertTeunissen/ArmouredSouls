...
export const FACILITY_TYPES: FacilityConfig[] = [
  ...
  },
  {
    ...
    description: 'Unlocks merchandising revenue. Note: Streaming revenue is now awarded per battle via Streaming Studio.',
    maxLevel: 10,
  ...
  },
  {
    ...
    benefits: [
      '+10% streaming revenue per battle (₡100/day operating cost)',
      '+20% streaming revenue per battle (₡200/day operating cost)',
      '+30% streaming revenue per battle (₡300/day operating cost)',
      '+40% streaming revenue per battle (₡400/day operating cost)',
      '+50% streaming revenue per battle (₡500/day operating cost)',
      '+60% streaming revenue per battle (₡600/day operating cost)',
      '+70% streaming revenue per battle (₡700/day operating cost)',
      '+80% streaming revenue per battle (₡800/day operating cost)',
      '+90% streaming revenue per battle (₡900/day operating cost)',
      '+100% streaming revenue per battle - double base rate (₡1,000/day operating cost)',
    ],
    implemented: true,
