...
export const FACILITY_TYPES: FacilityConfig[] = [
  ...
  },
  {
    ...
    benefits: [
      ...
      '60% discount on weapon purchases',
      '70% discount on weapon purchases',
      '80% discount on weapon purchases',
      '90% discount on weapon purchases',
      '100% discount on weapon purchases (free weapons)',
    ],
    implemented: true,
