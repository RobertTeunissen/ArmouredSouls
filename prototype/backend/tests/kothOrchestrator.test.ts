...
describe('KotH reward calculation', () => {
  ...
  it('1st place base rewards: 50000 credits, 8 fame, 15 prestige', () => {
  ...
  it('2nd place base rewards: 35000 credits, 5 fame, 8 prestige', () => {
  ...
  it('3rd place base rewards: 20000 credits, 3 fame, 3 prestige', () => {
  ...
  it('4th place participation rewards: 10000 credits, 0 fame, 0 prestige', () => {
  ...
  it('5th place participation rewards: 10000 credits, 0 fame, 0 prestige', () => {
  ...
  it('6th place participation rewards: 10000 credits, 0 fame, 0 prestige', () => {
  ...
  it('zone dominance bonus at 76% uncontested → 1.25× rewards for 1st place', () => {
    ...
    expect(result.credits).toBe(62_500);
